...
define('APP_DIR', $_SERVER['DOCUMENT_ROOT'] . '/public/erronka3pagina-master');
define('HREF_SRC_DIR', '/public/erronka3pagina-master/src');
define('HREF_IMAGES', '/public/erronka3pagina-master/web-comidas-main/img');
